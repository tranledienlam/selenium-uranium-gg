...
class Node:
    ...
    def wait_for_disappear(
        ...
        Args:
            ...
            wait (int, optional): Thời gian chờ trước khi điều hướng, mặc định là giá trị của `self.wait = 3`.
            timeout (int, optional): Thời gian tối đa để chờ (đơn vị: giây). Mặc định sử dụng giá trị `self.timeout = 20`.
    ...
    Args:
        ...
        wait (int, optional): Thời gian chờ (giây) trước khi nhấp. Mặc định là `self.wait`.
